...
size_t		count_bugs(t_game *game, char c);
size_t		get_frog_pos(t_game *game, char c);
size_t		get_exit_pos(t_game *game, char c);

/*IMAGE FUNCTIONS*/
t_img		*load_frog_texture(mlx_t *mlx, t_img *img);
t_img		*load_frog_N(mlx_t *mlx, t_img *img);
t_img		*load_frog_S(mlx_t *mlx, t_img *img);
t_img		*load_frog_W(mlx_t *mlx, t_img *img);
t_img		*load_frog_E(mlx_t *mlx, t_img *img);
